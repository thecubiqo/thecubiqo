...
export const V2_CAPABILITIES: V2Capability[] = [
  ...
  },
  {
    ...
    approvalRequestable: false,
    endpoint: null,
    summary: 'Locked until a user-visible browser runtime or extension session is designed.',
    requirements: ['browser runtime choice', 'domain allowlist', 'visible active indicator', 'stop button', 'session isolation'],
    externalAction: true
  },
  {
    ...
    approvalRequestable: false,
    endpoint: null,
    summary: 'Locked until browser sessions are visible, approved, isolated, and logged.',
    requirements: ['approved browser session', 'domain allowlist', 'screenshot/log redaction', 'cancel/stop path'],
    externalAction: true
  },
  {
    ...
    approvalRequestable: false,
    endpoint: null,
    summary: 'Locked until CubiQo can show data before typing it into a third-party site.',
    requirements: ['field preview', 'approved session', 'domain allowlist', 'audit log'],
    externalAction: true
  },
  {
    ...
    approvalRequestable: false,
    endpoint: null,
    summary: 'Locked until page-reading boundaries and source capture are implemented.',
    requirements: ['approved browser session', 'data minimization', 'source ledger', 'redaction'],
    externalAction: true
  },
  {
    ...
    approvalRequestable: false,
    endpoint: null,
    summary: 'Locked until screenshot redaction and session controls exist.',
    requirements: ['approved browser session', 'screenshot redaction', 'retention controls'],
    externalAction: true
  },
  {
