...
- ${
    isMandatory
      ? "You MUST suggest signing in this time"
...
export async function POST(request: NextRequest) {
  try {
    ...
    // const regionId = 'uk' // For testing purposes
    ...
    const fullSystemPrompt =
      SYSTEM_PROMPT + memoryContext + regionalContext + authNudge;
  ...
  return new NextResponse(null, {
    ...
    headers: {
      ...
      "Access-Control-Allow-Headers":
        "Content-Type, x-byo-claude-key, x-byo-openai-key",
    },
  });
}
