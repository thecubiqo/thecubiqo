  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center px-4">
        ...
        {/* Video popup trigger (floating) */}
        <div
          className={`absolute bottom-32 right-8 md:right-16 transition-all duration-1000 delay-700 ${
            showCTA ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
          <button
            className="group flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all"
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500/30 to-purple-500/30 flex items-center justify-center group-hover:scale-110 transition-transform">
