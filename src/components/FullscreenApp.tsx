...
export function FullscreenApp() {
  ...
  return (
    ...
    >
      ...
      {/* Left Content - Expanded Questions Widget */}
      <div className="fixed left-8 top-1/2 -translate-y-1/2 z-[40] w-[380px]">
        {/* Example Interactions - Expanded Premium ticker */}
        <div className="relative overflow-hidden rounded-3xl backdrop-blur-2xl border border-white/[0.08]" 
          ...
          <div className="h-[200px] relative overflow-hidden px-6 pb-5">
            <div className="absolute left-6 right-6 top-0 animate-scroll-vertical space-y-2.5">
              {[
                ...
                <div
                  key={i}
                  className="px-4 py-3 rounded-xl text-sm text-white/80 leading-relaxed"
                  style={{
            ...
            <div className="absolute inset-x-0 top-0 h-12 pointer-events-none" 
              style={{ background: 'linear-gradient(to bottom, rgba(20, 20, 25, 0.95), transparent)' }} />
            <div className="absolute inset-x-0 bottom-0 h-12 pointer-events-none" 
              style={{ background: 'linear-gradient(to top, rgba(20, 20, 25, 0.95), transparent)' }} />
          </div>
        </div>
      </div>
