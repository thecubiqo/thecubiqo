...
export function FullscreenApp() {
  ...
  // A: "What there is already" (Standard)
  // B: "Reflect existing + Match states" (Enhanced Plasma)
  ...
  const triggerRgyPulse = (color: 'RED' | 'YELLOW' | 'GREEN') => {
    ...
    const handleDevPrompt = useCallback(async (text: string) => {
      // Send directly to chat with system-level instruction prefix
    ...
    return (
      ...
      `}} />
        ...
        {/* Header - Cleaned up (No A/B Toggle) */}
        <header
