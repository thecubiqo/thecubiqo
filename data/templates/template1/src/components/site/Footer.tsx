      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <span className="font-bold tracking-widest">CubiQo™</span>
            </Link>
            <p className="text-sm text-white/50 mb-4">
              The Cooperative Virtual Assistant. Privacy-first AI companion.
            </p>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                ...
                <span className="text-xs text-white/70">App Store</span>
              </a>
              <a
                href="#"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
              >
                ...
                <span className="text-xs text-white/70">Google Play</span>
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} CubiQo. All rights reserved.
          </p>
